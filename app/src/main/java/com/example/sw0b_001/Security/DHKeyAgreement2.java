...
//        Log.i(this.getClass().getName(), "Use shared secret as SecretKey object ...");
    ...
    public static void test() throws Exception {
        ...
        Log.i("Alice pubkey:", Base64.encodeToString(alicePubKeyEnc, Base64.DEFAULT));

        // Takes alice pub key to generate own pub key and returns own pub key
        byte[] bobPubKeyEnc = bob.generateKeyFromPublicKey(alicePubKeyEnc);
        Log.i("Bob pubkey:", Base64.encodeToString(bobPubKeyEnc, Base64.DEFAULT));
